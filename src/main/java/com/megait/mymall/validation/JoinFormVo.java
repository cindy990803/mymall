 ...
 * ※VO(Value Object) ==> 읽기전용 dto. 한번 값이 정해지면 바꿀 수 없음
 */
...
public class JoinFormVo {
    ...
    //@NotBlank
    @AssertTrue(message = "반드시 약관에 동의하셔야 합니다.")
    ...
    public boolean isValidAddress() {
        return (postcode == null && baseAddress == null && detailAddress == null) ||
